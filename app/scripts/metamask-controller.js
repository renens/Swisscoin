...
//=============================================================================
  ...
  getState() {
    ...
    return {
      ...
      isTutorialReaded: isTutorialReaded
    }
  }
  ...
  getApi() {
    ...
    return {
      ...
      getAllTokens: nodeify(this.getAllTokens, this),
...
//=============================================================================
  ...
  importAccountWithStrategy(strategy, args, cb) {
    accountImporter.importAccount(strategy, args)
      ...
      .then(() => {
        cb(null, this.keyringController.fullUpdate())
      })
      .catch((reason) => {
        cb(reason)
      })
...
//=============================================================================
  ...
  tutorialReaded(done) {
    ...
    return new Promise(function (resolve, reject) {
      _this.configManager.setTutorialReaded(done)
      resolve(true)
    })
  ...
  getAllTokens = () => {
    return this.balancesController.getTokenBalance()
  }

  getTokenInfo=(address)=>{
    return this.tokenRatesController.getTokenInfo(address)
  }
