...
const lintTargets = ['app/**/*.json', 'app/**/*.js', '!app/scripts/vendor/**/*.js', 'ui/**/*.js', 'old-ui/**/*.js', 'mascara/src/*.js', 'mascara/server/*.js', '!node_modules/**', '!dist/firefox/**', '!docs/**', '!app/scripts/chromereload.js', '!mascara/test/jquery-3.1.0.min.js','app/css/*.css',]
...
function zipTask(target) {
  return () => {
    return gulp.src(`dist/${target}/**`)
      .pipe(zip(`swisswallet-${target}-${manifest.version}.zip`))
